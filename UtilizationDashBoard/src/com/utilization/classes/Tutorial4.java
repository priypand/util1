...
public class Tutorial4 {
	...
	public void preparePresentation(String filePath, String InSector, String InPal , String InIndustry,String InProject) throws IOException, ParseException, SQLException{
        ...
        r1.setText("Utilization Summery Report till: " +" Month : " + new SimpleDateFormat("MMMM").format(new Date())+" "+new Date().getYear() +" Week: "+ Calendar.getInstance().get(Calendar.WEEK_OF_YEAR));;
        ...
        for (Object str:Industry){
        	...
        	for(int i = 0; i < 5; i++) {
                ...
                if(i==1){
                	...
                	r.setText(Double.toString(trunc(rs.getDouble(1))));
                ...
                if(i==2){
                	...
                	r.setText(Double.toString(trunc(rs.getDouble(2))));
                    r.setFontSize(14.0);
                }
                if(i==3){
                	
                	r.setText(Double.toString(trunc(rs.getDouble(4))));
                    r.setFontSize(14.0);
                }
                if(i==4){
                	
                	r.setText(Double.toString(trunc(rs.getDouble(3))));
                    r.setFontSize(14.0);
                }
...
public static void createSlide(XMLSlideShow ppt, ResultSet rs,Object str1,ArrayList projectList, String palName) throws SQLException
{
    ...
    rp.setText("Utilization Report_"+str.toString()+" till Month : " + new SimpleDateFormat("MMMM").format(new Date())+" "+new Date().getYear() +" Week: "+ Calendar.getInstance().get(Calendar.WEEK_OF_YEAR));
    ...
    for(int j = 0; j < indColumn; j++) 
    {
        ...
        Indtbl.setColumnWidth(j, 75);
        
    }/////////end of the table header ////////////////////////////////////////////
    	
    		Boolean check=rs.next();
    		while (check&& Indtbl.getNumberOfRows()<=7)
			...
			for(int i = 0; i < 9; i++) {
                ...
                if (i==0){
                    ...
                    if(i==4){
                    	...
                    	detailR.setText(rs.getString(3));
                    	detailR.setFontSize(10.0);
                    }if(i==7){
    	 ...
    	 if(Indtbl.getNumberOfRows()>7 && check)
    	{
    		rs.relative(-1);
...
public static void createResourceSlide(XMLSlideShow ppt, String palName,Object Industry,String sector,ArrayList projList) throws SQLException
{
	...
	for(Object proj:projList){
    	...
    	if(totalDefault!=0){
    		...
    		pstmt = con.prepareStatement("SELECT INDUSTRY,PM_NOTE_ID FROM EMP_WISE_DETAIL WHERE  PROJECTNAME =? AND QTDCHARGEABLE = '<= 50%' ");
    		pstmt.setString(1,proj.toString() );
    	    ...
    	    for(int j = 0; j < projColumn; j++) 
    	    {
    	        ...
    	        if(j==1){
    	        	ir.setText(rsinner.getString(1));
    	        }
    	        if(j==2){
...
public static void main(String args[]) throws IOException, ParseException, SQLException{
	...
	String PL = "Deepak D Arora/India/IBM";
	String IN ="";
	String PR =" ";
	String FP = "C:\\Program Files\\Apache Software Foundation\\Tomcat 8.5\\webapps//PRESENTATION/UtilizationReport.pptx";
